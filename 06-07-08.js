...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      let nombresAmigos = this.amigos.map(amigo => amigo.nombre);
    ...
    getHobbies() {
      ...
      // Tu código aca:
      //let hobbiesPersona = this.amigos.map(amigo => amigo.hobbies);
      return this.hobbies;
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var sumaEdad = 0;
      this.amigos.forEach(element => sumaEdad += element.edad);
      var prom = sumaEdad/this.amigos.length;
      return prom;
